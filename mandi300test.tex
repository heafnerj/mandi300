...
\mandisetup{units=base,usepreciseconstants}
...
\hereusebaseunits{\momentum{4}},
\hereusederivedunits{\momentum{4}},
\hereusealternateunits{\momentum{4}}

\hereusebaseunits{\acceleration{4}},
\hereusederivedunits{\acceleration{4}},
\hereusealternateunits{\acceleration{4}}

\hereusebaseunits{\magneticfield{4}},
\hereusederivedunits{\magneticfield{4}},
\hereusealternateunits{\magneticfield{4}}
...
\momentumonlybaseunits, \momentumonlyderivedunits, \momentumonlyalternateunits
...
\pkg{mandi} knows every physical constant important to introductory physics. 

\( \oofpezmathsymbol = \oofpez \)
...
\chkconstant{clight}
\chkconstant{earthmass}
\chkconstant{earthmoondistance}
\chkconstant{earthradius}
\chkconstant{earthsundistance}
\chkconstant{electroncharge}
\chkconstant{electronCharge}
\chkconstant{electronmass}
\chkconstant{elementarycharge}
\chkconstant{finestructure}
\chkconstant{hydrogenmass}
\chkconstant{moonearthdistance}
\chkconstant{moonmass}
\chkconstant{moonradius}
\chkconstant{mzofp}
\chkconstant{neutronmass}
\chkconstant{oofpez}
\chkconstant{oofpezcs}
\chkconstant{planck}
\chkconstant{planckbar}
\chkconstant{planckc}
\chkconstant{protoncharge}
\chkconstant{protonCharge}
\chkconstant{protonmass}
\chkconstant{rydberg}
\chkconstant{stefanboltzmann}
\chkconstant{sunearthdistance}
\chkconstant{sunmass}
\chkconstant{sunradius}
